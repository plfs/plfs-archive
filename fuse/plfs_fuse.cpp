...
#define PFUS_ENTER vector<gid_t> orig_groups;                                 \
...
#define PFUS_EXIT  SET_IDS(s_uid,s_gid);                                \
                   RESTORE_GROUPS;                                      \
                   END_TIMES;                                           \
                   END_MESSAGE;					                        \
...
// every entry point in PFUS_ENTER which makes this a very frequent
...
// in a mutex which seems ugly since it happens at every PFUS_ENTER.  So
// if we indeed execute this code at every PFUS_ENTER, we should probably
